#!/bin/bash
#SBATCH --job-name=lsdv_unpur_plot
#SBATCH --output=lsdv_unpur_plot_%j.out
#SBATCH --error=lsdv_unpur_plot_%j.err
#SBATCH --ntasks=1
...
# FILE: Nottingham-MRes/figure_scripts/UnPur_cov_contig_plot_template.sh
#=============================================================================
...
###############################################################################
colors = {
    "05k": "#FFA07A",  # Light red (Light Salmon)
    "07k": "#CD5C5C",  # Medium red (Indian Red)
    "11k": "#B22222"   # Dark red (Fire Brick)
}
